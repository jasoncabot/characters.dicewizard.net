...
const speciesTraits = {
  Aasimar: {
    skinTones: ["#f5e6d3", "#e8d4c4", "#ffecd2"],
    hairColors: ["#f0f0f0", "#ffe066", "#c0c0c0"],
    eyeColor: "#ffd700",
    special: "halo",
    ears: "normal",
  },
  Dragonborn: {
    skinTones: ["#8b0000", "#006400", "#00008b", "#4b0082", "#b8860b"],
    hairColors: ["none"],
    eyeColor: "#ff4500",
    special: "scales",
    ears: "none",
  ...
  Dwarf: {
    skinTones: ["#e8b89d", "#d4a574", "#c49a6c"],
    hairColors: ["#8b4513", "#654321", "#a0522d", "#696969"],
    eyeColor: "#8b4513",
    special: "beard",
    ears: "normal",
  },
  Elf: {
    skinTones: ["#ffecd2", "#f5e6d3", "#e8d4c4", "#c2b280"],
    hairColors: ["#f0f0f0", "#ffd700", "#000000", "#8b4513"],
    eyeColor: "#00ff7f",
    special: "none",
    ears: "pointed",
  },
  Gnome: {
    skinTones: ["#f5e6d3", "#e8b89d", "#d4a574"],
    hairColors: ["#ff6b35", "#8b4513", "#f0f0f0", "#4169e1"],
    eyeColor: "#4169e1",
    special: "none",
    ears: "pointed-small",
  },
  Goliath: {
    skinTones: ["#808080", "#696969", "#a9a9a9"],
    hairColors: ["#000000", "#696969", "none"],
    eyeColor: "#4169e1",
    special: "tattoos",
    ears: "normal",
  },
  Halfling: {
    skinTones: ["#f5e6d3", "#e8b89d", "#d4a574"],
    hairColors: ["#8b4513", "#654321", "#daa520"],
    eyeColor: "#8b4513",
    special: "none",
    ears: "normal",
  },
  Human: {
    skinTones: ["#f5e6d3", "#e8b89d", "#d4a574", "#8b7355", "#6b4423"],
    hairColors: ["#000000", "#8b4513", "#654321", "#daa520", "#f0f0f0"],
    eyeColor: "#8b4513",
    special: "none",
    ears: "normal",
  },
  Orc: {
    skinTones: ["#556b2f", "#6b8e23", "#808000"],
    hairColors: ["#000000", "#2f4f4f", "none"],
    eyeColor: "#ff0000",
    special: "tusks",
    ears: "pointed",
  },
  Tiefling: {
    skinTones: ["#8b0000", "#800080", "#4b0082", "#dc143c"],
    hairColors: ["#000000", "#8b0000", "#4b0082"],
    eyeColor: "#ff0000",
    special: "horns",
    ears: "pointed",
  },
...
function generatePortrait(species, className) {
  ...
  const seed = (species + className)
    .split("")
    .reduce((acc, char) => acc + char.charCodeAt(0), 0);

  // Select colors based on seed
  const skinTone =
    speciesTrait.skinTones[
      Math.floor(seededRandom(seed) * speciesTrait.skinTones.length)
    ];
  const hairColor =
    speciesTrait.hairColors[
      Math.floor(seededRandom(seed + 1) * speciesTrait.hairColors.length)
    ];
  ...
  const hair =
    hairColor !== "none" ? generateHair(species, hairColor, className) : "";

  // Generate eyes
  const eyes = generateEyes(species, speciesTrait.eyeColor);

  // Generate special features (horns, tusks, scales, etc.)
  const special = generateSpecialFeatures(
    speciesTrait.special,
    species,
    skinTone,
    classTrait.primaryColor,
  );
...
function generateHair(species, hairColor, className) {
  ...
  const classHairStyles = {
    ...
    Monk:
      species === "Dwarf"
        ? shortHair
        : `<ellipse cx="100" cy="60" rx="38" ry="20" fill="${adjustColor(hairColor, -50)}"/>`, // Shaved/bald for monks
    Paladin: shortHair,
    Ranger: braided,
    Rogue: hooded,
    Sorcerer: wildHair,
...
function generateBody(species, classTrait) {
  const armorColors = {
    ...
    cloth: {
      primary: classTrait.primaryColor,
      secondary: classTrait.secondaryColor,
      highlight: adjustColor(classTrait.primaryColor, 30),
    },
    chainmail: {
      primary: "#808080",
      secondary: "#c0c0c0",
